...
import static org.GLFWUtil.*;
import static org.IOUtil.*;
...
public final class TTDemo {
    ...
    public static void main(String[] args) {
        new TTDemo().run("STB Truetype Oversample Demo");
    }
    ...
    private void load_fonts() {
        ...
        try ( STBTTPackContext pc = STBTTPackContext.malloc() ) {
            ByteBuffer ttf = ioResourceToByteBuffer("demo/BKANT.ttf", 160 * 1024);
    ...
    private void draw_world() {
        ...
        if ( !show_tex ) {
            if ( font < 3 )
                print(100, 350, sfont, "FontBitmap height: 24 pixels");
            else
                print(100, 350, sfont, "FontBitmap height: 14 pixels");
        }
